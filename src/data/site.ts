...
export const site: SiteConfig = {
  ...
  roles: ["C++ Programmer", "Frontend Developer", "DSA Practitioner", "Problem Solver"],

  bio: [
    "I'm Parth, a Computer Engineering undergraduate at Priyadarshini College of Engineering, Nagpur. My work centers on the fundamentals — data structures, object-oriented design, and systems — paired with the craft of shipping real interfaces.",
  ...
  seo: {
    title: "Parth Chittalwar — Computer Engineering Student",
    description:
      "Parth Chittalwar — Computer Engineering undergraduate building software through C++, DSA, and the MERN stack. Explore projects, skills, and engineering journey.",
  },
};
